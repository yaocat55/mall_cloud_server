...
public class AdminBasicController {
    ...
    public ResponsePageEntity<CommonJobDTO> searchJobPage(@RequestBody CommonJobConditionDTO condition) {
    ...
    public int deleteJob(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<CommonJobLogDTO> searchJobLogPage(@RequestBody CommonJobLogConditionDTO condition) {
    ...
    public int deleteJobLog(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<CommonPhotoDTO> searchPhotoPage(@RequestBody CommonPhotoConditionDTO condition) {
    ...
    public int deletePhoto(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<CommonPhotoGroupDTO> searchPhotoGroupPage(@RequestBody CommonPhotoGroupConditionDTO condition) {
    ...
    public int deletePhotoGroup(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<CommonSensitiveWordDTO> searchSensitiveWordPage(@RequestBody CommonSensitiveWordConditionDTO condition) {
    ...
    public int deleteSensitiveWord(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<SmsRecordDTO> searchSmsRecordPage(@RequestBody CommonSmsRecordConditionDTO condition) {
    ...
    public int deleteSmsRecord(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<DictDetailDTO> searchDictDetailPage(@RequestBody DictDetailConditionDTO condition) {
    ...
    public int deleteDictDetail(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<CommonNotifyDTO> searchNotifyPage(@RequestBody CommonNotifyConditionDTO condition) {
    ...
    public int deleteNotify(@RequestBody @NotNull List<Long> ids) {
