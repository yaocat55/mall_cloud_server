...
public class AdminShoppingController {
    ...
    public List<DeliveryAddressDTO> searchDeliveryAddressPage(@RequestBody Map<String, Object> c) {
    ...
    public int deleteDeliveryAddress(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<?> searchCommentPage(@RequestBody Map<String, Object> c) {
    ...
    public int deleteComment(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<?> searchFavoritesPage(@RequestBody Map<String, Object> c) {
    ...
    public int deleteFavorites(@RequestBody @NotNull List<Long> ids) {
    ...
    public int deleteViewRecord(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<?> searchCartPage(@RequestBody Map<String, Object> c) {
    ...
    public int deleteCart(@RequestBody @NotNull List<Long> ids) {
