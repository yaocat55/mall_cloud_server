...
public class AdminMarketingController {
    ...
    public ResponsePageEntity<?> searchSeckillPage(@RequestBody Map<String, Object> c) { return marketingFeignClient.searchSeckillPage(c); }
    ...
    public int deleteSeckill(@RequestBody @NotNull List<Long> ids) { return marketingFeignClient.deleteSeckillByIds(ids); }
    ...
    public ResponsePageEntity<?> searchProvidePage(@RequestBody Map<String, Object> c) { return marketingFeignClient.searchProvidePage(c); }
    ...
    public int deleteProvide(@RequestBody @NotNull List<Long> ids) { return marketingFeignClient.deleteProvideByIds(ids); }
    ...
    public ResponsePageEntity<?> searchReceivePage(@RequestBody Map<String, Object> c) { return marketingFeignClient.searchReceivePage(c); }
    ...
    public int deleteReceive(@RequestBody @NotNull List<Long> ids) { return marketingFeignClient.deleteReceiveByIds(ids); }
}
