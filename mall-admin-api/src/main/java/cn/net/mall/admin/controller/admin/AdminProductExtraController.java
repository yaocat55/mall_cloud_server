...
public class AdminProductExtraController {
    ...
    public ResponsePageEntity<?> searchAttributePage(@RequestBody Map<String, Object> c) {
    ...
    public int deleteAttribute(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<?> searchAttributeValuePage(@RequestBody Map<String, Object> c) {
    ...
    public int deleteAttributeValue(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<?> searchProductGroupPage(@RequestBody Map<String, Object> c) {
    ...
    public int deleteProductGroup(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<?> searchIndexNoticePage(@RequestBody Map<String, Object> c) {
    ...
    public int deleteIndexNotice(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<?> searchIndexProductPage(@RequestBody Map<String, Object> c) {
    ...
    public int deleteIndexProduct(@RequestBody @NotNull List<Long> ids) {
    ...
    public ResponsePageEntity<?> searchIndexCarouselImagePage(@RequestBody Map<String, Object> c) {
    ...
    public int deleteIndexCarouselImage(@RequestBody @NotNull List<Long> ids) {
