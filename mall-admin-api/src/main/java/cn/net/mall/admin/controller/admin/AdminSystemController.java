...
import cn.net.mall.auth.client.*;
...
public class AdminSystemController {
    ...
    public ResponsePageEntity<?> searchRolePage(@RequestBody Map<String, Object> c) { return roleFeignClient.searchByPage(c); }
    @Operation(summary = "查询所有角色", security = @SecurityRequirement(name = "Bearer Token"))
    @GetMapping("/role/all")
    public List<RoleDTO> allRoles() { return roleFeignClient.all(); }
    ...
    public int deleteRole(@RequestBody @NotNull List<Long> ids) { return roleFeignClient.deleteByIds(ids); }

    @Operation(summary = "分页查询菜单", security = @SecurityRequirement(name = "Bearer Token"))
    @PostMapping("/menu/page")
    public ResponsePageEntity<?> searchMenuPage(@RequestBody Map<String, Object> c) { return menuFeignClient.searchByPage(c); }
    @Operation(summary = "获取菜单树", security = @SecurityRequirement(name = "Bearer Token"))
    @GetMapping("/menu/tree")
    public List<MenuTreeDTO> getMenuTree() { return menuFeignClient.getMenuTree(); }
    @Operation(summary = "查询菜单列表", security = @SecurityRequirement(name = "Bearer Token"))
    @PostMapping("/menu/list")
    public List<MenuTreeDTO> getMenuList(@RequestBody Map<String, Object> c) { return menuFeignClient.getMenu(c); }
    ...
    public int deleteMenu(@RequestBody @NotNull List<Long> ids) { return menuFeignClient.deleteByIds(ids); }

    @Operation(summary = "分页查询部门", security = @SecurityRequirement(name = "Bearer Token"))
    @PostMapping("/dept/page")
    public ResponsePageEntity<?> searchDeptPage(@RequestBody Map<String, Object> c) { return deptFeignClient.searchByPage(c); }
    @Operation(summary = "查询部门树", security = @SecurityRequirement(name = "Bearer Token"))
    @PostMapping("/dept/tree")
    public List<DeptTreeDTO> getDeptTree(@RequestBody Map<String, Object> p) { return deptFeignClient.searchByTree(p); }
    ...
    public int deleteDept(@RequestBody @NotNull List<Long> ids) { return deptFeignClient.deleteByIds(ids); }

    @Operation(summary = "分页查询岗位", security = @SecurityRequirement(name = "Bearer Token"))
    @PostMapping("/job/page")
    public ResponsePageEntity<?> searchJobPage(@RequestBody Map<String, Object> c) { return jobFeignClient.searchByPage(c); }
    @Operation(summary = "查询所有岗位", security = @SecurityRequirement(name = "Bearer Token"))
    @GetMapping("/job/all")
    public List<JobDTO> allJobs() { return jobFeignClient.all(); }
    ...
    public int deleteJob(@RequestBody @NotNull List<Long> ids) { return jobFeignClient.deleteByIds(ids); }
}