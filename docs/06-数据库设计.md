...
| `mall-admin` | `cloud_mall_admin` | 单库 | 认证鉴权、RBAC（原名 mall-auth） |
| `mall-basic` | `cloud_mall_basic` | 单库 | 字典、行政区域、图片、短信、敏感词 |
| `mall-customer` | `cloud_mall_member` | 单库 | C 端用户注册登录 |
| `mall-product` | `cloud_mall_product` | 单库 | 商品中心、分类品牌、首页管理、购物车 |
| `mall-marketing` | `cloud_mall_marketing` | 单库 | 优惠券、秒杀 |
| `mall-order` | `cloud_mall_trade_0~7` | 8 库 × N 表 | 订单、退货 |
| `mall-pay` | 无 | — | 纯支付 API 对接 |
| `mall-recommend` | `cloud_mall_recommend_0~1` | 2 库 | 收藏、浏览历史 |
| `mall-message` | `cloud_mall_message_0~7` | 8 库 × 64 表 | 站内通知 |
