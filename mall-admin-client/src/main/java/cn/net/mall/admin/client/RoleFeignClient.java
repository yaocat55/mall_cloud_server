...
public interface RoleFeignClient {
    ...
    @PostMapping("/v1/internal/auth/role/searchByPage")
    ResponsePageEntity<?> searchByPage(@RequestBody Map condition);
    @Operation(summary = "查询所有角色")
    @GetMapping("/v1/internal/auth/role/all")
    List all();
    @Operation(summary = "新增角色")
    @PostMapping("/v1/internal/auth/role/insert")
    RowsDTO insert(@RequestBody Object entity);
    @Operation(summary = "修改角色")
    @PostMapping("/v1/internal/auth/role/update")
    RowsDTO update(@RequestBody Object entity);
    @Operation(summary = "删除角色")
    @PostMapping("/v1/internal/auth/role/deleteByIds")
