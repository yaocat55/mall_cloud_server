...
public class AdminProductManagerController {
    ...
    public ResponsePageEntity<?> searchCategoryPage(@RequestBody Map c) { return categoryFeignClient.searchByPage(c); }
    ...
    public int deleteCategory(@RequestBody @NotNull List ids) { return categoryFeignClient.deleteByIds(ids); }
    ...
    public List<?> getCategoryTree(@RequestBody Map c) { return categoryFeignClient.searchByTree(c); }

    @Operation(summary = "分页查询品牌", description = "多条件分页查询商品品牌列表", security = @SecurityRequirement(name = "Bearer Token"))
    @PostMapping("/brand/page")
    public ResponsePageEntity<?> searchBrandPage(@RequestBody Map c) { return brandFeignClient.searchByPage(c); }
    ...
    public int deleteBrand(@RequestBody @NotNull List ids) { return brandFeignClient.deleteByIds(ids); }

    @Operation(summary = "分页查询单位", description = "多条件分页查询商品单位列表", security = @SecurityRequirement(name = "Bearer Token"))
    @PostMapping("/unit/page")
    public ResponsePageEntity<?> searchUnitPage(@RequestBody Map c) { return unitFeignClient.searchByPage(c); }
    ...
    public int deleteUnit(@RequestBody @NotNull List ids) { return unitFeignClient.deleteByIds(ids); }
}