...
public class AdminProductManagerController {
    ...
    public ApiResult<String> insertCategory(@RequestBody Object e) { return ApiResultUtil.success(categoryFeignClient.insert(e)); }
    @Operation(summary = "修改分类", description = "修改已有商品分类的信息", security = @SecurityRequirement(name = "Bearer Token"))
    @PostMapping("/category/update")
    public ApiResult<String> updateCategory(@RequestBody Object e) { return ApiResultUtil.success(categoryFeignClient.update(e)); }
    @Operation(summary = "删除分类", description = "根据 ID 列表批量删除商品分类", security = @SecurityRequirement(name = "Bearer Token"))
    @PostMapping("/category/delete")
    public ApiResult<String> deleteCategory(@RequestBody @NotNull List ids) { return ApiResultUtil.success(categoryFeignClient.deleteByIds(ids)); }
    ...
    public ApiResult<String> insertBrand(@RequestBody Object e) { return ApiResultUtil.success(brandFeignClient.insert(e)); }
    @Operation(summary = "修改品牌", description = "修改已有商品品牌的信息", security = @SecurityRequirement(name = "Bearer Token"))
    @PostMapping("/brand/update")
    public ApiResult<String> updateBrand(@RequestBody Object e) { return ApiResultUtil.success(brandFeignClient.update(e)); }
    @Operation(summary = "删除品牌", description = "根据 ID 列表批量删除商品品牌", security = @SecurityRequirement(name = "Bearer Token"))
    @PostMapping("/brand/delete")
    public ApiResult<String> deleteBrand(@RequestBody @NotNull List ids) { return ApiResultUtil.success(brandFeignClient.deleteByIds(ids)); }
    ...
    public ApiResult<String> insertUnit(@RequestBody Object e) { return ApiResultUtil.success(unitFeignClient.insert(e)); }
    @Operation(summary = "修改单位", description = "修改已有商品单位的信息", security = @SecurityRequirement(name = "Bearer Token"))
    @PostMapping("/unit/update")
    public ApiResult<String> updateUnit(@RequestBody Object e) { return ApiResultUtil.success(unitFeignClient.update(e)); }
    ...
    public ApiResult<String> deleteUnit(@RequestBody @NotNull List ids) { return ApiResultUtil.success(unitFeignClient.deleteByIds(ids)); }
}
