...
public class AdminMarketingController {
    ...
    public ApiResult<Integer> insertCoupon(@RequestBody Object e) { return ApiResultUtil.success(marketingFeignClient.insert(e)); }
    @Operation(summary = "修改优惠券", description = "修改一条已有的优惠券记录", security = @SecurityRequirement(name = "Bearer Token"))
    @PostMapping("/coupon/update")
    public ApiResult<Integer> updateCoupon(@RequestBody Object e) { return ApiResultUtil.success(marketingFeignClient.update(e)); }
    ...
    public ApiResult<Integer> deleteCoupon(@RequestBody @NotNull List ids) { return ApiResultUtil.success(marketingFeignClient.deleteByIds(ids)); }
    ...
    public ApiResult<Integer> insertSeckill(@RequestBody Object e) { return ApiResultUtil.success(marketingFeignClient.insertSeckill(e)); }
    ...
    public ApiResult<Integer> updateSeckill(@RequestBody Object e) { return ApiResultUtil.success(marketingFeignClient.updateSeckill(e)); }
    ...
    public ApiResult<Integer> deleteSeckill(@RequestBody @NotNull List ids) { return ApiResultUtil.success(marketingFeignClient.deleteSeckillByIds(ids)); }
    ...
    public ApiResult<Integer> insertProvide(@RequestBody Object e) { return ApiResultUtil.success(marketingFeignClient.insertProvide(e)); }
    ...
    public ApiResult<Integer> updateProvide(@RequestBody Object e) { return ApiResultUtil.success(marketingFeignClient.updateProvide(e)); }
    ...
    public ApiResult<Integer> deleteProvide(@RequestBody @NotNull List ids) { return ApiResultUtil.success(marketingFeignClient.deleteProvideByIds(ids)); }
    ...
    public ApiResult<Integer> insertReceive(@RequestBody Object e) { return ApiResultUtil.success(marketingFeignClient.insertReceive(e)); }
    ...
    public ApiResult<Integer> updateReceive(@RequestBody Object e) { return ApiResultUtil.success(marketingFeignClient.updateReceive(e)); }
    ...
    public ApiResult<Integer> deleteReceive(@RequestBody @NotNull List ids) { return ApiResultUtil.success(marketingFeignClient.deleteReceiveByIds(ids)); }
}
