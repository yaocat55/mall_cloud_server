...
public class AdminCommonController {
    ...
    public ResponsePageEntity<?> searchAreaPage(@RequestBody Map c) { return areaFeignClient.searchByPage(c); }
    ...
    public int deleteArea(@RequestBody @NotNull List ids) { return areaFeignClient.deleteByIds(ids); }
    ...
    public ResponsePageEntity<?> searchDictPage(@RequestBody Map c) { return dictFeignClient.searchByPage(c); }
    ...
    public int deleteDict(@RequestBody @NotNull List ids) { return dictFeignClient.deleteByIds(ids); }
