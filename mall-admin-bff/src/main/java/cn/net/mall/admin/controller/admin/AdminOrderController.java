...
public class AdminOrderController {
    ...
    @PostMapping("/page")
    public ResponsePageEntity<?> searchPage(@RequestBody OrderConditionDTO c) {
        return orderFeignClient.searchByPage(c);
    }
    ...
    public ResponsePageEntity<?> searchReturnPage(@RequestBody OrderReturnConditionDTO c) {
        return orderFeignClient.searchReturnByPage(c);
    }
    ...
    public Object findReturnById(@RequestParam("id") Long id) {
        return orderFeignClient.findReturnById(id);
    }
}
