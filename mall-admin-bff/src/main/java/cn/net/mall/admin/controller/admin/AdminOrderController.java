...
public class AdminOrderController {
    ...
    @PostMapping("/delete")
    public int delete(@RequestBody @NotNull List ids) { return orderFeignClient.delete(ids); }
    ...
    public ResponsePageEntity<?> searchDeliveryAddressPage(@RequestBody Map c) { return orderFeignClient.searchDeliveryAddressPage(c); }
    ...
    public int deleteDeliveryAddress(@RequestBody @NotNull List ids) { return orderFeignClient.deleteDeliveryAddressByIds(ids); }
    ...
    public ResponsePageEntity<?> searchReturnPage(@RequestBody Map c) { return orderFeignClient.searchReturnByPage(c); }
