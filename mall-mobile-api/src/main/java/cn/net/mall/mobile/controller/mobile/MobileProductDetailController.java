...
public class MobileProductDetailController {
    ...
    public Map<String, Object> getDetail(@PathVariable("productId") Long productId) {
    ...
    @PostMapping("/search")
    public ResponsePageEntity<ProductSearchResultDTO> search(@RequestBody ProductSearchConditionDTO condition) {
    ...
    public ResponsePageEntity<ProductCommentDTO> searchComment(@RequestBody ProductCommentConditionDTO condition) {
    ...
    @GetMapping("/category")
    public List<CategoryDTO> getCategory(@RequestParam("parentId") Long parentId) {
