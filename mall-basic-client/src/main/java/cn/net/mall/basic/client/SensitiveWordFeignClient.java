...
public interface SensitiveWordFeignClient {
    ...
    @GetMapping("/v1/internal/commonSensitiveWord/findById")
    Object findById(@RequestParam("id") Long id);

    @Operation(summary = "校验敏感词", description = "校验文本内容中是否包含敏感词，返回校验结果")
    @PostMapping("/v1/internal/commonSensitiveWord/checkSensitiveWord")
    ...
    @PostMapping("/v1/internal/commonSensitiveWord/searchByPage")
