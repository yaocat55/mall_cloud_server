 ...
 * @date 2025/07/15
 */
@Schema(description = "商品图片查询条件DTO")
@Data
public class ProductPhotoConditionDTO extends RequestConditionEntity {
    ...
    @Schema(description = "商品ID集合", example = "0")
    ...
    @Schema(description = "图片类型 1：封面 2：轮播图", example = "1")
