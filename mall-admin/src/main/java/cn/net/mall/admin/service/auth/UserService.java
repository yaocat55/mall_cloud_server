...
import cn.net.mall.admin.authenication.SmsAuthenticationToken;
import cn.net.mall.admin.dto.*;
import cn.net.mall.admin.entity.auth.*;
import cn.net.mall.admin.entity.auth.web.UserPhoneLoginWebEntity;
import cn.net.mall.admin.entity.auth.web.UserWebEntity;
import cn.net.mall.admin.mapper.auth.*;
import cn.net.mall.admin.util.PasswordUtil;
...
import static cn.net.mall.admin.util.CaptchaKeyUtil.getCaptchaKey;
