...
import cn.net.mall.auth.entity.auth.UserAvatarConditionEntity;
import cn.net.mall.auth.entity.auth.UserAvatarEntity;
import cn.net.mall.auth.service.auth.UserAvatarService;
